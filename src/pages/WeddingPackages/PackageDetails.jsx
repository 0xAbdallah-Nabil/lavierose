function PackageDetails({ selectedPackage, closeModal }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-fadeIn">
      <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8">
          ...
          <a
            href="#contact"
            className={`block w-full py-4 rounded-full font-semibold text-white text-center bg-gradient-to-r ${selectedPackage.gradient} hover:shadow-xl transition-all duration-300 text-lg`}
          >
