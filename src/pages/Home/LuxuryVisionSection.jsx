...
function LuxuryVisionSection() {
  return (
    <section className="relative bg-gradient-to-b from-white via-rose-50/30 to-white py-16 px-6 overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-0 left-1/4 w-72 h-72 bg-rose-100/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-pink-100/20 rounded-full blur-3xl"></div>
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        {/* Subtitle */}
        <p className="text-base md:text-lg text-gray-700 mb-6 font-light leading-relaxed max-w-3xl mx-auto">
        ...
        {/* Main Content */}
        <div className="space-y-4 text-sm md:text-base text-gray-600 leading-relaxed max-w-3xl mx-auto">
          <p>
          ...
          <p className="text-lg md:text-xl font-light text-gray-800 mt-8">
